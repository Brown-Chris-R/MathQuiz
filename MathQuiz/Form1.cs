...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        // Integer variables to store the numbers
        ...
        {
            // Generate random numbers for the 
            // addition problem
            addend1 = randomizer.Next(51);
            addend2 = randomizer.Next(51);

            // Replace the left and right form labels 
            // with the random numbers
            plusLeftLabel.Text = addend1.ToString();
            plusRightLabel.Text = addend2.ToString();

            // Set the NumericUpDown control value to zero
            sum.Value = 0;
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            ...
            // dont allow the start button after the quiz has already started
        ...
        {
            // Set currentDate label to show the current date
